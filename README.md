...
10. Use `New Mission` during a run and after a completed mission, then confirm the save clears and the start overlay returns.
11. Start each challenge mode once and confirm credits, sell rules, enemy durability, scoring, and restart behavior match the selected mode.
