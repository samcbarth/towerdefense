export const GAME_DATA = {
  ...
  art: {
    ...
    towers: {
      rifle: {
        base: { src: "assets/towers/rifle/base.png", width: 52, height: 52, anchorX: 0.5, anchorY: 0.72 },
        branches: {
          rapid: { src: "assets/towers/rifle/rapid.png", width: 54, height: 54, anchorX: 0.5, anchorY: 0.72 },
          piercer: { src: "assets/towers/rifle/piercer.png", width: 52, height: 52, anchorX: 0.5, anchorY: 0.72 },
        },
      },
      missile: {
        base: { src: "assets/towers/missile/base.png", width: 56, height: 56, anchorX: 0.5, anchorY: 0.72 },
        branches: {
          cluster: { src: "assets/towers/missile/cluster.png", width: 56, height: 56, anchorX: 0.5, anchorY: 0.72 },
          bunker: { src: "assets/towers/missile/bunker.png", width: 56, height: 56, anchorX: 0.5, anchorY: 0.72 },
        },
      },
      railgun: {
        base: { src: "assets/towers/railgun/base.png", width: 54, height: 54, anchorX: 0.5, anchorY: 0.72 },
        branches: {
          overcharge: { src: "assets/towers/railgun/overcharge.png", width: 58, height: 58, anchorX: 0.5, anchorY: 0.72 },
          cycling: { src: "assets/towers/railgun/cycling.png", width: 56, height: 56, anchorX: 0.5, anchorY: 0.72 },
        },
      },
      emp: {
        base: { src: "assets/towers/emp/base.png", width: 54, height: 54, anchorX: 0.5, anchorY: 0.72 },
        branches: {
          freeze: { src: "assets/towers/emp/freeze.png", width: 54, height: 54, anchorX: 0.5, anchorY: 0.72 },
          breaker: { src: "assets/towers/emp/breaker.png", width: 54, height: 54, anchorX: 0.5, anchorY: 0.72 },
        },
      },
      drone: {
        base: { src: "assets/towers/drone/base.png", width: 54, height: 54, anchorX: 0.5, anchorY: 0.72 },
        branches: {
          interceptor: { src: "assets/towers/drone/interceptor.png", width: 58, height: 58, anchorX: 0.5, anchorY: 0.72 },
          hunter: { src: "assets/towers/drone/hunter.png", width: 56, height: 56, anchorX: 0.5, anchorY: 0.72 },
        },
      },
    },
    enemies: {
      scout: { src: "assets/enemies/scout.png", width: 26, height: 26, anchorX: 0.5, anchorY: 0.54 },
      carrier: { src: "assets/enemies/carrier.png", width: 34, height: 34, anchorX: 0.5, anchorY: 0.56 },
      shield: { src: "assets/enemies/shield.png", width: 26, height: 26, anchorX: 0.5, anchorY: 0.54 },
      swarm: { src: "assets/enemies/swarm.png", width: 24, height: 24, anchorX: 0.5, anchorY: 0.54 },
      jammer: { src: "assets/enemies/jammer.png", width: 26, height: 26, anchorX: 0.5, anchorY: 0.54 },
      splitter: { src: "assets/enemies/splitter.png", width: 20, height: 20, anchorX: 0.5, anchorY: 0.5 },
      mender: { src: "assets/enemies/mender.png", width: 34, height: 34, anchorX: 0.5, anchorY: 0.56 },
      bastion: { src: "assets/enemies/bastion.png", width: 42, height: 42, anchorX: 0.5, anchorY: 0.58 },
      boss: { src: "assets/enemies/boss.png", width: 58, height: 58, anchorX: 0.5, anchorY: 0.6 },
    },
    projectiles: {
      rifle: { src: "assets/projectiles/rifle.png", width: 8, height: 8, anchorX: 0.5, anchorY: 0.5 },
      missile: { src: "assets/projectiles/missile.png", width: 10, height: 18, anchorX: 0.5, anchorY: 0.5 },
      railgun: { src: "assets/projectiles/railgun.png", width: 10, height: 10, anchorX: 0.5, anchorY: 0.5 },
      emp: { src: "assets/projectiles/emp.png", width: 12, height: 12, anchorX: 0.5, anchorY: 0.5 },
      drone: { src: "assets/projectiles/drone.png", width: 12, height: 12, anchorX: 0.5, anchorY: 0.5 },
    },
  },
  abilities: {
